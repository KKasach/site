        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
			...
			<?php
				...
				?> 
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="cabinet.php">Cabinet</a>
					</li>
					<li class="nav-item px-lg-4">
					...
					?> 
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="login.php">Log UP</a>
					</li>
					<li class="nav-item px-lg-4">
						<a class="nav-link text-uppercase text-expanded" href="reg.php">Registration</a>
					</li>
					<?php
					}
					?>
